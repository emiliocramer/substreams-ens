    ...
    pub mod functions {
        ...
        impl substreams_ethereum::rpc::RPCDecodable<ethabi::Uint> for Commitments {
            fn output(data: &[u8]) -> Result<ethabi::Uint, String> {
                Self::output(data)
            }
        }
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct MakeCommitmentWithConfig {
            pub name: String,
            pub owner: Vec<u8>,
            pub secret: [u8; 32usize],
            pub resolver: Vec<u8>,
        ...
        impl MakeCommitmentWithConfig {
            const METHOD_ID: [u8; 4] = [61u8, 134u8, 197u8, 47u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for MakeCommitmentWithConfig {
            const NAME: &'static str = "makeCommitmentWithConfig";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<ethabi::Uint> for MaxCommitmentAge {
            fn output(data: &[u8]) -> Result<ethabi::Uint, String> {
                Self::output(data)
            }
        }
        ...
        impl substreams_ethereum::rpc::RPCDecodable<ethabi::Uint> for MinCommitmentAge {
            fn output(data: &[u8]) -> Result<ethabi::Uint, String> {
                Self::output(data)
            }
        }
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::String(self.name.clone()),
                        ethabi::Token::Address(ethabi::Address::from_slice(&self.owner)),
                        ethabi::Token::Uint(self.duration),
                        ethabi::Token::FixedBytes(self.secret.as_ref().to_vec()),
                    ],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
        ...
        impl RegisterWithConfig {
            const METHOD_ID: [u8; 4] = [247u8, 161u8, 105u8, 99u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for RegisterWithConfig {
            const NAME: &'static str = "registerWithConfig";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<ethabi::Uint> for RentPrice {
            fn output(data: &[u8]) -> Result<ethabi::Uint, String> {
                Self::output(data)
            }
        }
        ...
        pub struct SetCommitmentAges {
            pub min_commitment_age: ethabi::Uint,
            pub max_commitment_age: ethabi::Uint,
        }
        impl SetCommitmentAges {
            ...
            pub fn decode(
                ...
                values.reverse();
                Ok(Self {
                    min_commitment_age: values
                        .pop()
                        .expect(INTERNAL_ERR)
                        .into_uint()
                        .expect(INTERNAL_ERR),
                    max_commitment_age: values
                        .pop()
                        .expect(INTERNAL_ERR)
                        .into_uint()
                        .expect(INTERNAL_ERR),
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Uint(self.min_commitment_age),
                        ethabi::Token::Uint(self.max_commitment_age),
                    ],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
                encoded.extend(Self::METHOD_ID);
    ...
    pub mod events {
        ...
        pub struct NameRegistered {
            ...
            pub owner: Vec<u8>,
            pub cost: ethabi::Uint,
            pub expires: ethabi::Uint,
        }
        impl NameRegistered {
